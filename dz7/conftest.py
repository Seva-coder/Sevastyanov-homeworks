...
sys.path.append(os.path.join(BASE_DIR, 'todo'))        # todo = sheduler
...
def pytest_configure(config):
    ...
    # settings.AUTHENTICATION_BACKENDS = ['tests.base.utils.py.AuthBackend']
    # settings.MIDDLEWARE += ['tests.base.utils.py.AuthMiddleware']
